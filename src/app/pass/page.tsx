...
import { FEST, STAMP_MISSIONS, STAMP_REWARD, courseName } from "@/lib/config";
        ...
        <div className="space-y-6">
          ...
          <section className="fest-card p-6">
            <div className="flex items-center justify-between gap-3">
              ...
              <Link href="/companies" className="fest-btn-outline fest-btn-sm">
                기업 더 보기
              </Link>
            </div>
