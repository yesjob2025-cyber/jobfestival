...
import { FEST, ZONES, COURSES, STAMP_REWARD } from "@/lib/config";
import { listCompanies, listEvents, listJobs, listPromos } from "@/lib/repo";
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-fest-navy text-white">
        ...
        <div className="fest-container relative py-16 sm:py-24">
          ...
          <div className="mt-9 flex flex-wrap gap-3">
            <Link href="/register" className="fest-btn bg-fest-lime text-fest-navy hover:bg-[#a5dd3d]">
              사전등록하고 입장 QR 받기
            </Link>
            <Link
              href="/guide"
      ...
      <section className="fest-container py-16 sm:py-20">
        ...
        <div className="mt-8 rounded-2xl border border-fest-blue/20 bg-fest-sky p-6 sm:flex sm:items-center sm:justify-between sm:gap-6">
          ...
          <Link href="/guide" className="fest-btn-primary fest-btn-sm mt-4 sm:mt-0">
            이벤트 자세히 보기
          </Link>
        </div>
      </section>
      ...
      <section className="border-t border-fest-line bg-white py-16 sm:py-20">
        <div className="fest-container">
          <div className="flex items-end justify-between gap-4">
            ...
            <Link href="/companies" className="fest-btn-outline fest-btn-sm shrink-0">
              기업관 전체보기
            </Link>
          </div>
      ...
      <section className="fest-container py-16">
        <div className="fest-card px-6 py-8 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link href="/register" className="fest-btn-primary">
              사전등록 바로가기
            </Link>
            <Link href="/about" className="fest-btn-outline">
              행사 안내 보기
            </Link>
          </div>
        </div>
