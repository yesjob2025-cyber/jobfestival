...
import { getCompany, getVisitor, listApplications } from "@/lib/repo";
          ...
          {visitor ? (
            ...
            <div className="py-10 text-center">
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-3">
                ...
                <Link href="/pass/find" className="fest-btn-outline">
                  이미 등록했어요
                </Link>
              </div>
            </div>
        ...
        <aside className="space-y-5">
          {alreadyHere.length > 0 && (
            <div className="fest-card p-5">
              ...
              <Link href="/pass" className="fest-btn-outline fest-btn-sm mt-3 w-full">
                지원 현황 보기
              </Link>
            </div>
          )}
