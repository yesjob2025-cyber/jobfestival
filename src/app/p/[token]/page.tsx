...
import { getVisitorByToken, stampProgress } from "@/lib/repo";
import { getStaffSession } from "@/lib/session";
import { courseName, FEST, STAMP_MISSIONS } from "@/lib/config";
      ...
      <div className="mx-auto max-w-md space-y-5">
        ...
        {staff ? (
          <div className="fest-card p-6">
            ...
            <Link href="/staff/scan" className="fest-btn-outline fest-btn-sm mt-3 w-full">
              연속 스캔 화면으로
            </Link>
          </div>
        ) : (
          <div className="fest-card p-6 text-center">
            ...
            <Link href="/staff" className="fest-btn-primary mt-4 w-full">
              부스 운영자 로그인
            </Link>
          </div>
        )}
